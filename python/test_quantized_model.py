...
encoder_session = ort.InferenceSession("trocr_onnx/encoder_model_quantized.onnx")
decoder_session = ort.InferenceSession("trocr_onnx/decoder_model_quantized.onnx")
